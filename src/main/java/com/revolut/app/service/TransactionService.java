...
public class TransactionService {
    ...
    private BigDecimal calculateExchangedAmountConverted(Transaction transaction, Account accountEntity) {
    	String fromCurrency = transaction.getCurrency();
    	String toCurrency =  accountEntity.getCurrency();
    	
    	validator.validateCurrencies(fromCurrency, toCurrency);
    	
        return transaction.getAmount()
                .multiply(exchangeRateService.exchangeAmount(fromCurrency, toCurrency));
    }
